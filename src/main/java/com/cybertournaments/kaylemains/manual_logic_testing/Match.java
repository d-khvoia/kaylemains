...
public class Match {
    ...
    public Match(Long id, Tournament tournament, Participant firstParticipant, Participant secondParticipant, LocalDateTime startTime, LocalDateTime finishTime) {
        this.id = id;
